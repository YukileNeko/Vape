local function vapeGithubRequest(scripturl)
    if not isfile(scripturl) then
        local suc, res = pcall(function() return game:HttpGet("https://raw.githubusercontent.com/YukileNeko/Vape/main/"..scripturl, true) end)
...
if isfile("CustomModules/6872274481.lua") then
    ...
    local publicrepo = vapeGithubRequest("6872274481.lua")
    if publicrepo then
